...
public class SuperSpinAttack extends SkillBase implements ISkillModifier
{
	...
	public void addInformation(List<String> desc, EntityPlayer player) {
		desc.add(new TextComponentTranslation(getTranslationKey() + ".info.range", String.format("%.1f", getRangeModifier())).getUnformattedText());
		desc.add(new TextComponentTranslation(getTranslationKey() + ".info.spins", level).getUnformattedText());
	}
