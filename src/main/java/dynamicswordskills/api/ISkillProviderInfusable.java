...
/**
 * 
 * Interface for {@link ISkillProvider} Items that can be upgraded by infusing them with skill orbs.
 * 
 */
public interface ISkillProviderInfusable extends ISkillProvider {

	/**
	 * Number of matching skill orbs required to infuse the stack with the new or upgraded skill
	 * @param stack The ISkillProviderInfusable stack
	 * @param skill The skill to be infused
	 * @return 0 or less to prevent infusion, otherwise the number of orbs to be consumed [1 - 8]
	 */
	 ...
	 * @param stack The ISkillProviderInfusable stack being infused
