...
public class AttackTimePacket implements IMessage
{
	...
	/*
	public static class AttackTimePacketHandler extends AbstractBiMessageHandler<AttackTimePacket> {
		@Override
		public IMessage handleClientMessage(EntityPlayer player, AttackTimePacket message, MessageContext ctx) {
			player.attackTime = message.attackTime;
			return null;
		}

		@Override
		public IMessage handleServerMessage(EntityPlayer player, AttackTimePacket message, MessageContext ctx) {
			player.attackTime = message.attackTime;
			return null;
		}
	}
...
/*
public class AttackTimePacket extends AbstractPacket
{
	private int attackTime;
