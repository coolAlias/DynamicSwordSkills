...
public class Config
{
	...
	public static void refreshClient() {
		...
		enableAdditionalControls = config.get("client", "dss.config.client.enableAdditionalControls", false, "Enables additional keybindings that can be used to attack, block, and activate skills").setRequiresMcRestart(true).getBoolean(false);
