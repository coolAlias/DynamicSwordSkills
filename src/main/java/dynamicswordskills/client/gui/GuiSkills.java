...
public class GuiSkills extends GuiScreen
{
	...
	public static class SkillSlotContainer extends GuiElementContainer<SkillSlot>
	{
		...
		protected void renderToolTip(SkillBase skill, Minecraft mc, int mouseX, int mouseY) {
			...
			if (skill.getLevel() < 1) {
				String displayName = (skill.showNameIfUnknown(mc.thePlayer) ? skill.getDisplayName() : new TextComponentTranslation("skill.dss.unknown.name").getUnformattedText());
				...
				skill.getTooltip(this.skillScreen.mc.thePlayer, false).stream().forEach(s -> tooltip.add(TextFormatting.GRAY + s));
			}
